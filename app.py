...
def fetch_remaining_schedule():
    return [
        {"R": 26, "날짜": "09.14(토) 16:30", "장소": "수원종합운동장", "홈팀": "수원 FC", "원정팀": "수원 삼성 블루윙즈"},
        {"R": 26, "날짜": "09.15(일) 19:00", "장소": "목동종합운동장", "홈팀": "서울 이랜드 FC", "원정팀": "대구 FC"},
        {"R": 26, "날짜": "09.15(일) 19:00", "장소": "화성종합경기타운", "홈팀": "화성 FC", "원정팀": "부산 아이파크"},
        {"R": 27, "날짜": "09.21(토) 16:30", "장소": "DGB대구은행파크", "홈팀": "대구 FC", "원정팀": "수원 삼성 블루윙즈"},
        {"R": 27, "날짜": "09.21(토) 19:00", "장소": "부산아시아드", "홈팀": "부산 아이파크", "원정팀": "수원 FC"},
        {"R": 27, "날짜": "09.22(일) 19:00", "장소": "목동종합운동장", "홈팀": "서울 이랜드 FC", "원정팀": "화성 FC"},
        {"R": 28, "날짜": "09.28(토) 16:30", "장소": "수원종합운동장", "홈팀": "수원 FC", "원정팀": "서울 이랜드 FC"},
        {"R": 28, "날짜": "09.29(일) 19:00", "장소": "DGB대구은행파크", "홈팀": "대구 FC", "원정팀": "화성 FC"}
    ]
...
st.caption("🔮 감마-포아송 베이지안 추론 기반 몬테카를로 시뮬레이션 (최신 순위 반영)")
st.divider()
...
with col1:
    st.subheader("🗓️ 잔여 경기 승패 예측")
    st.caption("라운드별 주요 경기 승패를 조절하여 시뮬레이션에 즉시 반영해 보세요.")
