...
# 3. NumPy 초고속 벡터화 베이지안 포아송 연산 엔진 (0.1초 완료)
@st.cache_data(show_spinner=False)
def run_fast_bayesian_simulation(completed, scheduled, past_user_choices_tuple, future_user_choices_tuple, total_games=34, n_sims=5000):
    ...
    # 5,000회 시뮬레이션 행렬 일괄 생성
    pts_sim = np.tile(base_pts, (n_sims, 1))
    
    # 5,000개의 공격/수비 파라미터 무작위 샘플링 (Shape: 5000 x 17)
