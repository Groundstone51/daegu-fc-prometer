...
st.info("공식 순위 및 1~26라운드 실제 결과를 바탕으로 잔여 경기 몬테카를로 승격 확률을 예측합니다.")
...
with col2:
    ...
    rank_matrix, teams, team_idx = run_simulation(
        df_standings, remaining_matches, form_w, home_adv, total_games=34, n_sims=sim_count
    )
